...
📋 Аргументы:
  ...
  ✨ Для управления доп. командами — муу, адд, скрафтить, гифт, пок, ач, рек, херомант, медаль, дд, ив, ивр, ивт, ивс, ивя, иви, ивм, ивз, гб, коров(ка)"""
