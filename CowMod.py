...
📋 Аргументы:
  🐄 Для управления коровкой — мук, мус, муп, мулс, мув, муз, муд, муа, муш, муг, муко, муку, мул, мукр, мун, муф, муб, муби, пок, ач
  ...
  ✨ Для управления доп. командами — муу, адд, скрафтить, х|хер[омант]"""
    ...
    async def client_ready(self, client, db):
        ...
        self.cow_actions = {"мук": "Мук", "мулс": "Мулс", "муф": "Муф", "муа": "Муа", "муп": "Муп", "муш": "Муш", "мус": "Мус", "мув": "Мув", "муз": "Муз", "муд": "Муд", "муко": "Муко", "муку": "Муку", "мул": "Мул", "муг": "Муг", "муби": "Муби", "муб": "Муб", "мукр": "Мукр", "муу": "Муу", "мун": "Мун", "пок": "Пок", "ач": "Ач"}
